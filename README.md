...
| `events.jsonl` | Structured event stream (LLM calls, tool I/O, handoffs, skill-index offers, outage waits/recovery, dangerous-command refusals, the run's protection posture) |
