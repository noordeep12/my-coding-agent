...
Usage (standalone):
    uv run python examples/agentic_discovery.py
    uv run python examples/agentic_discovery.py --force   # overwrite existing

Importable:
    from examples.agentic_discovery import run_discovery
