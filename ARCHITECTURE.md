...
└── utils.py                     ← Response-parsing helpers + exception hierarchy
```
...
### Context Handoff (`pipeline/handoff.py` + `pipeline/nodes/context_preflight.py`)
